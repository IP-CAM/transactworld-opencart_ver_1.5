...
// if everything is ok, try to upload file
		...
		if (isset($this->request->post['paymentz_partner_id']))
        {
            $this->data['paymentz_partner_id'] = $this->request->post['paymentz_partner_id'];
        }
        else
        {
            $this->data['paymentz_partner_id'] = $this->config->get('paymentz_partner_id');
        }
		
		
		if (isset($this->request->post['paymentz_ipaddr']))
        {
            $this->data['paymentz_ipaddr'] = $this->request->post['paymentz_ipaddr'];
        }
        else
        {
            $this->data['paymentz_ipaddr'] = $this->config->get('paymentz_ipaddr');
        }
	...
	private function validate() {
		...
		if (!$this->request->post['paymentz_partner_id']) {
			$this->error['partner_id'] = $this->language->get('error_partner_id');
		}
		
		if (!$this->request->post['paymentz_ipaddr']) {
